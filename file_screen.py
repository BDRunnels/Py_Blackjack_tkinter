...
main_window.geometry("640x720-8-200")
main_window["padx"] = 8
...
rb_value.set(1)
# Radio buttons
radio1 = tkinter.Radiobutton(option_frame, text="File Name", value=1, variable=rb_value)
...
minutes_spinner = tkinter.Spinbox(time_frame, width=2, from_=0, to=59)
...
month_spin = tkinter.Spinbox(date_frame, width=5, values=("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Sep", "Oct", "Nov", "Dec"))
